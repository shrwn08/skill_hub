    ...
    <div className="pt-28">
      ...
      <section className="px-4 sm:px-8 lg:px-16 py-20 sm:py-28 bg-linear-to-br from-(--cream) to-(--light) border-b border-(--soil)/10 relative overflow-hidden text-(--soil)">
        ...
        <h1 className="font-[Fraunces] text-[clamp(2rem,5vw,3.6rem)] font-black mb-4 leading-snug">
          From skill to{" "}
          <em className="italic text-(--amber) font-light">launch</em>,<br />
          guided every step
        </h1>
        <p className="max-w-xl text-sm sm:text-base opacity-70">
          EntreSkill Hub takes the guesswork out of starting a micro-business.
          Here's exactly how our platform works — from your very first quiz to
      ...
      <section className="px-4 sm:px-8 lg:px-16 py-12 sm:py-20 space-y-12">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow border border-(--soil)/5 space-y-2">
              ...
              <div className="flex flex-col gap-1 text-sm sm:text-xs">
                <div className="flex items-center gap-2">
                  <span className="text-(--amber)">✓</span> Sewing & Tailoring
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-(--amber)">✓</span> Cooking & Baking
                </div>
        ...
        <Step
          ...
          tags={[
            ...
            {
              text: "60+ business templates",
              color: "bg-(--soil)/5 text-(--soil)",
            },
            {
              text: "Skill-match scoring",
              color: "bg-(--sage)/10 text-(--sage)",
            },
          ]}
          visual={
            <div className="space-y-2">
              <IdeaResult
                ...
                subtitle="Tailoring + Craft"
                percent="96%"
              />
              <IdeaResult
                icon="🍳"
                title="Home Chef Services"
                subtitle="Cooking + Nutrition"
                percent="91%"
              />
              <IdeaResult
                icon="🎂"
                title="Artisan Bakery"
                subtitle="Baking + Packaging"
                percent="84%"
              />
            </div>
          }
          ...
          visual={
            <div>
              <RoadmapStep
                ...
                subtitle="Talk to 5 potential customers ✅"
              />
              <RoadmapStep
                done
                title="Plan Your Costs"
                subtitle="Equipment & materials budget ✅"
              />
              <RoadmapStep
                current
              ...
              <RoadmapStep
                ...
                subtitle="Set up social media & portfolio"
              />
              <RoadmapStep
                title="Get Your First Customer"
                subtitle="Launch & marketing plan"
              />
            </div>
          }
        />
